...
export function CreateTripPage() {
  ...
  // Modal
  const [isGuestModalOpen, setIsGetModalOpen] = useState(false);

  //armazenar os emails
  const [emailsToInvite, setEmailsToInvite] = useState(["luciana@teste.com"]);
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
        ...
        <div className="space-y-4">
          ...
          {isGuestsInputOpen && (
            <InviteGuestsStep
              ...
              OpenTripConfirmModal={OpenTripConfirmModal}
            />
          )}
        </div>
      ...
      {isConfirmTripModalOpen && (
        <ConfirmTripModal
          closeTripConfirmModal={closeTripConfirmModal}
